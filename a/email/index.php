...
<body>
  ...
  if ($result->num_rows > 0) {
    ...
    echo '<div style="margin-left: 10px;"><p>No emails.</p></div>';
  }
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($_POST['action'] == 'view') {
      $posteduid = $_POST['uid'];
      echo "<iframe src='../../a/email/view.php?uid=$posteduid' style='width:80%; margin-left: 20%; height:100%; border-left: 1px solid black; z-index: 999; position:fixed; top:50px; left:0; bottom:0; right:0;'>
  Your browser does not support the viewer.</iframe>";
    } else {
      if ($_POST['action'] == 'send') {
        echo "<iframe src='../../a/email/send.php' style='width:80%; margin-left: 20%; height:100%; border-left: 1px solid black; z-index: 999; position:fixed; top:50px; left:0; bottom:0; right:0; '>
        Your browser does not support the viewer.</iframe>";
      } else {
        if ($_POST['action'] == 'sent') {
          echo "<iframe src='../../a/email/sent.php' style='width:80%; margin-left: 20%; height:100%; border-left: 1px solid black; z-index: 999; position:fixed; top:50px; left:0; bottom:0; right:0;'>
          Your browser does not support the viewer.</iframe>";
        }
      }
    }
